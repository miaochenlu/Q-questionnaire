  ...
  // button  div
    ...
    //relation button
      ...
      if(type == 4) {
        ...
        + "<li class = \"row\" >"
        + "<input style=\" 120px;\" class = \"col-md-7 form-control\" type = \"number\" id = \"ques_" + ques_count + ".number\" name= \"ques_" + ques_count + ".number\"  min=\"3\" max=\"10\" placeholder = \"量表级数\" required/> </li>"
      }
